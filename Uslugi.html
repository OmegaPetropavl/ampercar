    ...
    <header class="header" id="header">
        <div class="container">
          <nav class="navbar navbar-expand-xxxxl navbar-light align-content-sm-between">
            ...
            <div class="logo">
                <a class="navbar-brand" id="logo-first" href="https://yandex.kz"><img src="images/logo1.png" alt="Logo"></a>
              </div>
            <div class="text-end">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                <li class="nav-item">
                  <a class="nav-link" href="index.html">Автомобили</a>
                </li>
                ...
                <li class="nav-item">
                    <nav class="main-nav">
                        <ul>
                            <li>
                            <div class="logsign">
                            <a class="cd-signin" href="#0"><img src="images/logsign.png" alt="Logo" title="Вход/Регистрация"></a>
                            </div>
                        </li>
...
<main class="main-uslugi">
    <section>
        <div class="container">
            <h2 class="sub-title2">Наши услуги</h2>
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                <div class="col">
                    <div class="card card-2 text-center">
                        <div class="card__top">
                            <a href="/service/remont-hodovki">
                                <img alt="Ремонт ходовой части" class="card-img-top" src="https://tehservice.kz/storage/app/uploads/public/f37/154/353/thumb__260_183_0_0_auto.jpg" style="max-width: 310px; max-height: 183px; min-width: 260px; min-height: 183px;">
                            </a>
                        </div>
                        <div class="card-body" style="max-height: 104px; min-height: 104px;">
                            <h4 class="card-title">Ремонт ходовой части</h4>
                        </div>
                        <div class="card-footer text-center">
                            <div class="car-item-price">
                                <h3 class="price">Цена: в зависимости от объема работ</h3>
                            </div>
                            <div class="car-item-action">
                                <button class="button car-button">Выбрать услугу</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card card-2 text-center">
                        <div class="card__top">
                            <a href="/service/remont-hodovki">
                                <img alt="Ремонт ходовой части" class="card-img-top" src="https://cdn.create.vista.com/api/media/medium/421420384/stock-photo-close-view-wheel-mechanic-repairing?token=" style="max-width: 310px; max-height: 183px; min-width: 260px; min-height: 183px;">
                            </a>
                        </div>
                        <div class="card-body" style="max-height: 104px; min-height: 104px;">
                            <h4 class="card-title">Ремонт тормозной системы</h4>
                        </div>
                        <div class="card-footer text-center">
                            <div class="car-item-price">
                                <h3 class="price">Цена: в зависимости от объема работ</h3>
                ...
                <div class="col">
                    <div class="card card-2 text-center">
                        <div class="card__top">
                            <a href="/service/remont-hodovki">
                                <img alt="Ремонт ходовой части" class="card-img-top" src="https://grandtuning.net/wp-content/uploads/2021/08/service3-1024x596.jpg" style="max-width: 310px; max-height: 183px; min-width: 260px; min-height: 183px;">
                            </a>
                        </div>
                        <div class="card-body" style="max-height: 104px; min-height: 104px;">
                            <h4 class="card-title">Замена стекол</h4>
                        </div>
                        <div class="card-footer text-center">
                            <div class="car-item-price">
                                <h3 class="price">Цена: в зависимости от объема работ</h3>
                    ...
                    <div class="card card-2 text-center">
                        <div class="card__top">
                            <a href="/service/remont-dvigatelya">
                                <img alt="Ремонт ДВС любой сложности" class="card-img-top" src="https://tehservice.kz/storage/app/uploads/public/2e9/967/f73/thumb__260_183_0_0_auto.jpg" style="max-width: 310px; max-height: 183px; min-width: 260px; min-height: 183px;">
                            </a>
                        </div>
                        <div class="card-body" style="max-height: 104px; min-height: 104px;">
                            <h4 class="card-title">Ремонт ДВС любой сложности</h4>
                        </div>
                        <div class="card-footer text-center">
                            <div class="car-item-price">
                                <h3 class="price">Цена: в зависимости от объема работ</h3>
                ...
                <div class="col">
                    <div class="card card-2 text-center">
                        <div class="card__top">
                            <a href="/service/remont-hodovki">
                                <img alt="Автоэлектрик" class="card-img-top" src="https://tehservice.kz/storage/app/uploads/public/037/e7d/10f/thumb__260_183_0_0_auto.jpg" style="max-width: 310px; max-height: 183px; min-width: 260px; min-height: 183px;">
                            </a>
                        </div>
                        <div class="card-body" style="max-height: 104px; min-height: 104px;">
                            <h4 class="card-title">Замена масла в АКПП/ДВС/ГУР</h4>
                        </div>
                        <div class="card-footer text-center">
                            <div class="car-item-price">
                                <h3 class="price">Цена: в зависимости от объема работ</h3>
                ...
                <div class="col">
                    <div class="card card-2 text-center">
                        <div class="card__top">
                            <a href="/service/remont-hodovki">
                                <img alt="Ремонт ходовой части" class="card-img-top" src="https://tehservice.kz/storage/app/uploads/public/6a7/1c0/c49/thumb__260_183_0_0_auto.jpg" style="max-width: 310px; max-height: 183px; min-width: 260px; min-height: 183px;">
                            </a>
                        </div>
                        <div class="card-body" style="max-height: 104px; min-height: 104px;">
                            <h4 class="card-title">Чистка топливных форсунок</h4>
                        </div>
                        <div class="card-footer text-center">
                            <div class="car-item-price">
                                <h3 class="price">Цена: в зависимости от объема работ</h3>
                ...
                <div class="col">
                    <div class="card card-2 text-center">
                        <div class="card__top">
                            <a href="/service/remont-hodovki">
                                <img alt="Компьютерная диагностика двигателя" class="card-img-top" src="https://tehservice.kz/storage/app/uploads/public/d3c/ce7/b4e/thumb__260_183_0_0_auto.jpg" style="max-width: 310px; max-height: 183px; min-width: 260px; min-height: 183px;">
                            </a>
                        </div>
                        <div class="card-body" style="max-height: 104px; min-height: 104px;">
                            <h4 class="card-title">Компьютерная диагностика двигателя</h4>
                        </div>
                        <div class="card-footer text-center">
                            <div class="car-item-price">
                                <h3 class="price">Цена: в зависимости от объема работ</h3>
                ...
                <div class="col">
                    <div class="card card-2 text-center">
                        <div class="card__top">
                            <a href="/service/remont-hodovki">
                                <img alt="Капитальный ремонт" class="card-img-top" src="https://img.freepik.com/premium-photo/car-engine-overhaul-powerful-diesel-engine_254309-2518.jpg?w=1800" style="max-width: 310px; max-height: 183px; min-width: 260px; min-height: 183px;">
                            </a>
                        </div>
                        <div class="card-body" style="max-height: 104px; min-height: 104px;">
                            <h4 class="card-title">Капитальный ремонт</h4>
                        </div>
                        <div class="card-footer text-center">
                            <div class="car-item-price">
                                <h3 class="price">Цена: в зависимости от объема работ</h3>
    ...
    <h2 class="sub-title2">Фотоотчеты проведенных работ</h2>
    <div id="myCarousel" class="carousel slide container" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/images/work2.jpg" class="d-block w-100" alt="Image 1">
          </div>
          <div class="carousel-item">
            <img src="/images/work1.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item">
            <img src="/images/work3.jpg" class="d-block w-100" alt="Image 3">
          </div>
          <div class="carousel-item">
            <img src="https://cdn.create.vista.com/api/media/medium/421420384/stock-photo-close-view-wheel-mechanic-repairing?token=" 
    ...
    <section class="price" id="price">
        <div class="container">
            <h2 class="sub-title">Заказать услугу</h2>
            <div class="price-text">
                Для уточнения всех деталей предоставления услуг, пожалуйста зарегестрируйтесь.<br> Есть аккаунт? <nav class="main-nav"><ul><li><a class="" href="#0">Войти в аккаунт</a></li></ul></nav>
            </div>
            <form class="price-form" name="form" id="form" onsubmit="return validation()">
                ...
                <div class="radio-form">
                    <input type="radio" name="group1" value="Male"> Мужчина<br>
